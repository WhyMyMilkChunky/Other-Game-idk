Shader "Custom/PS1AffineMove"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                // Implement lighting calculations here if needed
            }
            
            float4 calculateMainLight()
            {
                // Implement main light calculations here if needed
            }
            ...
            v2f vert (appdata v)
            {
                ...
                // Apply UV animation
                o.uv = v.uv + _Time.y * _UVSpeed; // You can change _Time.y to _Time.x or _Time.z for different effects
            ...
            {
                // Sample the texture with animated UV
                ...
                clip(Color.a - 0.5); // Adjust threshold as needed
